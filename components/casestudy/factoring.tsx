          ...
          <table className="table-fixed text-center">
            <tbody>
              <tr className="text-center gap-1">
                ...
                <td className="bg-[#f9f9f9] p-4">Info-Solution Pvt Ltd </td>
              </tr>
              <tr>
                <td className="bg-[#f3f3f3] p-4">Commencement year</td>
                <td className="bg-[#f3f3f3] p-4">2011 </td>
              </tr>
              <tr>
                <td className="bg-[#f9f9f9] p-4">Turnover</td>
                <td className="bg-[#f9f9f9] p-4 ">9.5Cr </td>
              </tr>
              <tr>
                <td className="bg-[#f3f3f3] p-4">Mortage Available</td>
                <td className="bg-[#f3f3f3]">None</td>
              </tr>
              <tr>
                <td className="bg-[#f3f3f3] p-4">Industry Type</td>
                <td className="bg-[#f3f3f3]">Service Industry</td>
              </tr>
            </tbody>
          </table>
        </div>
