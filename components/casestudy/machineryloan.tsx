          ...
          <table className="table-fixed text-center">
            <tbody>
              <tr className="text-center gap-1">
                ...
                <td className="bg-[#f9f9f9] p-4">Rs. 37 Cr.</td>
              </tr>
              <tr>
                <td className="bg-[#f3f3f3] p-4">Amount Required for Machinery</td>
                <td className="bg-[#f3f3f3] p-4">Rs. 7.5 Cr.</td>
              </tr>
              <tr>
        ...
        <div className="w-full">
          <table className="table- text-center">
            <tbody>
              ...
              <tr>
                <td className="bg-[#f3f3f3] p-4">Amount Disbursed For Machine</td>
                <td className="bg-[#f3f3f3] p-4">Rs. 7.5 Cr.</td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td className="bg-[#f3f3f3]"> 4.3/5</td>
              </tr>             
            </tbody>
          </table>
