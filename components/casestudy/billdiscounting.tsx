    ...
    <div className="px-40 py-10 text-[#7c7c7c]">
      <div className="">
        ...
        <p className="p-5 text-[17px] tracking-[0.7px]">
          ...
          invoice and his customer will pay it after a certain period of time at
          the decided due date, it takes 30 to 90 days to get the invoice paid
          by the client. John’s payment thus gets stuck and his working capital
        ...
        <p className="p-5 text-[17px] tracking-[0.7px]">
          ...
          had many times planned for the export, but every time he stopped
          because of these challenges. But this time he is very stubborn. And he
      ...
      <div className="px-28 grid grid-cols-2 gap-2 text-[17px] tracking-[0.7px]">
        ...
        <div className="p-5  shadow-xl">
          <p className="">
            ...
            financial institution. But he realizes he has no asset or property
            which he can keep as a mortgage. Also, paying interest on the entire
          ...
          <table className="table-fixed text-center">
            <tbody>
              <tr className="text-center gap-1">
                ...
                <td className="bg-[#f9f9f9] p-4">Rs. 7.5 Crores </td>
              </tr>
              <tr>
              ...
              <tr>
                <td className="bg-[#f9f9f9] p-4">Mortgage Availability </td>
                <td className="bg-[#f9f9f9] p-4 "> No Mortgage</td>
              </tr>
              <tr>
                <td className="bg-[#f3f3f3] p-4">Company Industry</td>
                <td className="bg-[#f3f3f3]">Manufacturing Industry</td>
              </tr>
            </tbody>
          </table>
        </div>
      ...
      <div>
        ...
        <p className="p-5 text-[17px] tracking-[0.7px]">
          ...
          without a mortgage. We suggested Bill Discounting Facility for his
          business situation. This was a perfect fit considering his
          requirements and his business. We explained to him the entire process
          of the bill discounting facility, before starting the procedure.
        </p>
      </div>
      ...
      <div>
        ...
        <p className="p-5 text-[17px] tracking-[0.7px]">
          ...
          institutions discounted the bill and the margin was decided as per the
          agreed terms. As per invoice financing, the financial institution has
          given the required exposure of Rs. 1.3 crores, which John can use as
        ...
        <p className="p-5 text-[17px] tracking-[0.7px]">
          ...
          amount from the customer against the invoice, the cycle for charging
          interest stopped. So, John found purchase bill discounting very useful
          and it gave more flexibility to his business.
        </p>
      </div>
        ...
        <table className="table-fixed text-center">
            <tbody>
              <tr className="text-center gap-1">
                ...
                <td className="bg-[#f9f9f9] p-4">2010</td>
              </tr>
              <tr>
                <td className="bg-[#f3f3f3] p-4">Amount Disbursed </td>
                <td className="bg-[#f3f3f3] p-4">Rs. 1.3 Crores</td>
              </tr>
              <tr>
                <td className="bg-[#f9f9f9] p-4">Moratorium Period </td>
                <td className="bg-[#f9f9f9] p-4 "> 5 Working Days </td>
              </tr>
              <tr>
                <td className="bg-[#f3f3f3] p-4">Customer Service Experience  </td>
      ...
      <div className="">
        ...
        <div className="w-full">
          ...
          <p className="p-5 text-[17px] tracking-[0.7px]">
            ...
            So, now, he is one of our loyal customers at Terkar Capital.
          </p>
        </div>
      </div>
      ...
      <div>
        ...
        <p className="p-5 text-[17px] tracking-[0.7px]">
          ...
          approached Terkar Capital for assistance. Understanding his situation
          and the risks involved, we recommended trade funding to bridge the gap
          in working capital for his export business. With no collateral
          available, Terkar Capital ensured John’s funding needs were met.
        </p>
      </div>
