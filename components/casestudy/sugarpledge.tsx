  ...
  return (
    <div className="px-40 py-10 text-[#7c7c7c]">
      <div className="">
        ...
        The process of Sugar Pledge Loan (Case Study)
        </h1>
          ...
          <table className="table-fixed text-center">
            <tbody>
              <tr className="text-center gap-1">
                ...
                <td className="bg-[#f9f9f9] p-4">Rs. 4500 Crores </td>
              </tr>
              <tr>
                <td className="bg-[#f3f3f3] p-4">
                  Amount Of Funding Required{" "}
                </td>
                <td className="bg-[#f3f3f3] p-4">Rs. 350 Crores</td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td className="bg-[#f3f3f3]">Sugar Manufacturing </td>
              </tr>
            </tbody>
          </table>
        </div>
          ...
          <table className="table-fixed text-center">
            <tbody>
              <tr className="text-center gap-1">
                ...
                <td className="bg-[#f9f9f9] p-4">2015</td>
              </tr>
              <tr>
              ...
              <tr>
                ...
                <td className="bg-[#f3f3f3] p-4 ">4.3/5</td>
              </tr>
            </tbody>
          </table>
          <p className="p-5 text-[17px] tracking-[0.7px]">
