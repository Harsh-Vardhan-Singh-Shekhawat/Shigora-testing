    ...
    <div className="px-2 max-w-7xl m-auto">
      ...
      <div className="text-[#7a7a7a]">
        ...
        <p className="py-4 text-[17px] tracking-[0.7px]">
          Medical/hospital equipment is often expensive, which can hinder the
          provision of quality healthcare. Healthcare providers may not have the
          financial resources to purchase equipment outright, which can limit
          their ability to provide the most up-to-date and best care to their
          patients. There are several ways that healthcare providers can
          overcome this barrier, such as leasing equipment, financing it through
          a loan, or partnering with a medical equipment company.
        </p>
        <p className="py-4 text-[17px] trackinng-[0.7px]">
          So, we understand the importance of improving healthcare facilities.
          Whether you’re looking to expand your medical unit with cutting-edge
          equipment through a doctor’s loan or explore equipment financing
          options, we’re here to help. Our financing options are intended to be
      ...
      <div className="text-[#7a7a7a] ">
        ...
        <p className="py-4 text-[17px] tracking-[0.7px]">
          Terkar Capital is a leading medical equipment financing company. We
          arrange funding or loans to help healthcare organizations acquire
          medical equipment. This allows them to upgrade their technology, which
          improves medical services and patient care. So, the influx of funds
          strengthens our commitment to upgrading healthcare facilities,
          ensuring better access to equipment and advancing medical treatment
          capabilities within their network. So, Finance Your Medical Equipment
          with Terkar Capital Today!!
        </p>
      </div>
      ...
      <div className="text-[#7a7a7a] ">
        ...
        <p className="py-5 text-[17px] tracking-[0.7px]">
          The following documentation is required to apply for Medical Equipment
          Loans.
        </p>

        <div className="p-4 text-[17px] tracking-[0.7px]">
          <ul className="list-disc">
            <li>Identifying Proof: PAN Card, Aadhar Card</li>
            <li>
              Ownership Proof: Electricity bill or Lease Agreement, Passport
              size Photo
            </li>
            <li>
              Company Documents: Pan Card, Certificate of Incorporation, Udyam
              Certificate, GST certificate, Rent Agreement or Electricity Bill
            </li>
            <li>Financial Audited Report</li>
            <li>Current Account Banking Statement</li>
            <li>Medical Degree Certificate</li>
            <li>vCertificate of Practice</li>
          </ul>
        </div>
      </div>
      ...
      <div className="text-[#7a7a7a] ">
        ...
        <div className="p-4 text-[17px] tracking-[0.7px]">
          <ul className="list-disc">
            <li>Indian residents with a minimum of one year of experience</li>
            <li>The age range of 25 to 65 years</li>
            <li>Should have a healthy cash flow and A good credit history</li>
            <li>
              Capable of making a down payment of 10-20% of the price of the
              equipment
            </li>
          </ul>
        </div>
