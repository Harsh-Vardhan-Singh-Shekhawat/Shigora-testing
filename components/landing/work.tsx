  ...
  return (
    <div className='text-center '>
      ...
      <div className='grid  grid-cols-1 sm:grid-cols-1 md:grid-cols-2 text-white text-left text-[20px] justify-center'>
        ...
        <div className="h-[300px] bg-[url('/How-do-we-work-1-1024x512.webp')] bg-no-repeat bg-contain ">
        </div>
        <div className="h-[300px]  bg-[url('/How-do-we-work-4-1024x512.webp')] p-10 bg-no-repeat bg-cover brightness-50">
        ...
        <div className="h-[300px] bg-[url('/How-do-we-work-2-1024x512.webp')] bg-no-repeat bg-contain">
        </div>
        <div className="h-[300px] bg-[url('/How-do-we-work-6-1024x512.webp')] p-10 bg-no-repeat bg-cover brightness-50">
        ...
        <div className="h-[300px] bg-[url('/How-do-we-work-3-1024x512.webp')] bg-no-repeat bg-contain">
        </div>
      </div>
    </div>
  )
