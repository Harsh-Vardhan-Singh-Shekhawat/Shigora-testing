...
const work = () => {
  return (
    <div className='text-center'>
      <h1 className='text-[30px] font-bold p-10'>How do we work?</h1>

      <div className='grid grid-cols-2 text-[#7a7a7a]'>
        <div className="h-[300px] bg-[url('/How-do-we-work-5-1024x512.webp')] p-10 bg-no-repeat bg-cover ">
        ...
        <div className="h-[300px] bg-[url('/How-do-we-work-4-1024x512.webp')] p-10 bg-no-repeat bg-cover ">
        ...
        <div className="h-[300px] bg-[url('/How-do-we-work-6-1024x512.webp')] p-10 bg-no-repeat bg-cover">
